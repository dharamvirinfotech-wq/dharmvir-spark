...
const MboxToPdf = () => (
  <>
    <Seo
      title="MBox to PDF Converter — Thunderbird, Apple Mail & More | Dharam Vir Infotech"
      description="Convert MBOX email archives to court-ready PDF/A with attachments. Bulk convert Thunderbird, Apple Mail, SeaMonkey & Eudora mailboxes."
      path="/software/mbox-to-pdf"
      image="/og/mbox-to-pdf.jpg"
    />
