...
const data: SoftwareProductData = {
  ...
  reviews: [
    { name: "Linda Park", role: "Litigation Paralegal", initials: "LP", quote: "Converted 40 GB of Thunderbird archives into searchable PDFs for case prep. Saved us weeks." },
    { name: "Joseph Wright", role: "Compliance Officer", initials: "JW", quote: "PDF/A output is exactly what our retention policy requires. Filters are powerful." },
    { name: "Mei Tanaka", role: "Migration Consultant", initials: "MT", quote: "Handles huge MBOX files without crashing. The attachment options are a big plus." },
    { name: "Daniel Cooper", role: "Solo Attorney", initials: "DC", quote: "Simple, fast, and the conversion log is great for documenting chain of custody." },
  ],
