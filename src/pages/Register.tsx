          ...
          <div className="bg-card rounded-2xl shadow-xl border border-border p-8">
            ...
            <div className="grid grid-cols-2 gap-3 mb-6">
              <a
                ...
                className="flex items-center justify-center gap-2 border border-border rounded-lg py-2.5 px-3 text-sm font-medium text-foreground hover:bg-muted transition-colors"
              >
              ...
              <a
                ...
                className="flex items-center justify-center gap-2 bg-[#1877F2] text-white rounded-lg py-2.5 px-3 text-sm font-medium hover:bg-[#166FE5] transition-colors"
              >
