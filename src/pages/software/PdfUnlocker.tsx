...
const data: SoftwareProductData = {
  ...
  reviews: [
    { name: "Anita Verma", role: "Office Manager", initials: "AV", quote: "Unlocked 600 client PDFs in a single batch. The output looks identical to the originals — life-saver." },
    { name: "Roberto Silva", role: "Architect", initials: "RS", quote: "I needed to copy text from secured construction drawings. Worked on the first try." },
    { name: "Hannah Lee", role: "Researcher", initials: "HL", quote: "Best PDF unlocker I've tried. Clean UI and no nagware." },
    { name: "Tom Becker", role: "IT Support", initials: "TB", quote: "Standard install on all our office machines. Support team replies within hours." },
  ],
