...
const GmailBackup = () => (
  <>
    <Seo
      title="Gmail Backup Tool — Backup Gmail to PST, PDF, MBOX & EML | Dharam Vir Infotech"
      description="Backup Gmail and Google Workspace mailboxes to PST, PDF, MBOX, EML or MSG. OAuth secured, preserves labels & attachments. Free trial included."
      path="/software/gmail-backup-tool"
      image="/og/gmail-backup.jpg"
    />
