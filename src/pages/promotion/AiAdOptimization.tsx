...
import { Target, Target, BarChart3, Settings, Users, Shield } from "lucide-react";

const AiAdOptimization = () => (
  <PromotionServiceTemplate
    title="AI Ad Optimization"
    subtitle="Optimize ad spend and performance with AI-driven strategies."
    breadcrumb="AI Ad Optimization"
    features={[
